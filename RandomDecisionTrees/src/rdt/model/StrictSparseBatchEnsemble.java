 ...
 * @author MK
 */
public class StrictSparseBatchEnsemble extends Ensemble{
	 ...
	 */
	public StrictSparseBatchEnsemble(CollectorPreferences cp, int numTrees, int maxDeep, int maxS, long randomSeed, int noSplitAttrs) throws RDTException {
		super(cp, new SparseBatchTreeBuilder(cp, maxDeep, maxS, randomSeed, noSplitAttrs, true), numTrees);
	}
